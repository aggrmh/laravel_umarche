                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <form id="delete_{{ $owner->id }}" method="post" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id ])}}">
                                    @csrf
                                  <td class="px-4 py-3">
                                    <a data-id="{{ $owner->id }}" href="#" onclick="deletePost(this)" class="text-red bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded text-lg">完全削除</a>
                                  </td>
                                  </form>
                                </tr>
                                @endforeach
